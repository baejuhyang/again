...
console.log(obj); // {model: 'IONIQ 5', company: 'HYUNDAI', year: 2023, options: Array(2)}
...
console.log(json); // {"model":"IONIQ 5","company":"HYUNDAI","year":2023,"options":["side mirror","smart sensor"]}
