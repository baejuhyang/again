...
// setSeachParams vs searchParams.set()차이
// - setSeachParams
//   - 새로운 객체를 전달.
//   - 기존의 쿼리 파라미터가 "전부 덮어 씌워짐"
// - searchParams.set()
// const params = new URLSearchParams(searchParams);
// params.set('mode', 'dark'); // 기존 파라미터 유지하여 'mode'만 변경 // 바로 변경되지 않고 임시저장임
// setSearchParams(params); // 적용시키기 위해 setSearchParams를 이용해야 함. -> 번거로움

// - URLSearhcParams 객체에서 제공하는 메서드.
// ㄴ 객체 내부에서 수정.
